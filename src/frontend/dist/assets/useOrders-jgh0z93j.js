...
import { g as Subscribable, s as shallowEqualObjects, h as hashKey, i as getDefaultState, n as notifyManager, f as useQueryClient, r as reactExports, k as noop$1, l as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, b as cn, m as createSlot$1, o as composeRefs, R as React2, e as useComposedRefs, p as reactDomExports, q as React, t as ReactDOM } from "./index-Cjc0hVuN.js";
import { C as ChevronDown, u as useQuery } from "./skeleton-CYfH1Xre.js";
...
function PhoneInput({
  ...
  const [selectedDial, setSelectedDial] = reactExports.useState(parsed.dial);
  const [localNumber, setLocalNumber] = reactExports.useState(parsed.number);
  const [open, setOpen] = reactExports.useState(false);
  const [search, setSearch] = reactExports.useState("");
  const dropdownRef = reactExports.useRef(null);
  const selectedCountry = COUNTRY_CODES.find((c) => c.dial === selectedDial) ?? COUNTRY_CODES[0];
  const filtered = search ? COUNTRY_CODES.filter(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex gap-1.5", className), "data-ocid": dataOcid, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base leading-none", children: selectedCountry.flag }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground", children: selectedDial }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3 text-muted-foreground ml-0.5" })
          ]
        }
      ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-h-48 overflow-y-auto", children: [
                filtered.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base leading-none w-5", children: c.flag }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono w-10 flex-shrink-0", children: c.dial }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-foreground truncate", children: c.name })
                    ]
                  },
                  `${c.code}-${c.dial}`
                )),
                filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-4", children: "No results" })
              ] })
            ]
          }
        )
