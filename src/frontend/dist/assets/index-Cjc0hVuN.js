const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/OrdersPage-l5ga8AnI.js","assets/useOrders-jgh0z93j.js","assets/skeleton-CYfH1Xre.js","assets/circle-alert-Bsm47dXp.js","assets/QuotationsPage-D5pNE7tQ.js","assets/ReportsPage-CspVPk7f.js"])))=>i.map(i=>d[i]);
...
function AppHeader({ subtitle }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 bg-card border-b border-border shadow-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 h-14 max-w-[480px] mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center shadow-card flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          viewBox: "0 0 24 24",
          fill: "none",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "17", cy: "12", r: "1", fill: "oklch(var(--accent))" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "path",
              {
                d: "M7 15h6",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-base leading-tight text-foreground tracking-tight", children: "PrintTrack" }),
        subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground leading-none", children: subtitle })
      ] })
    ] }),
...
function BottomNav({ activeTab, onTabChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-stretch h-16", children: TABS.map((tab) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-8 h-0.5 rounded-full bg-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Icon2,
                {
                  className: cn(
...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React2.useState(null), [lt, J2] = React2.useState(null), [W2, H2] = React2.useState(false), [A, mt] = React2.useState(false), [L, z2] = React2.useState(false), [ct, d] = React2.useState(false), [h, y] = React2.useState(false), [R, j] = React2.useState(0), [p, _2] = React2.useState(0), O2 = React2.useRef(t.duration || X || Wt), G = React2.useRef(null), k = React2.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N2 = t.type, V2 = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React2.useMemo(() => S.findIndex((r2) => r2.toastId === t.id) || 0, [S, t.id]), Jt = React2.useMemo(() => {
    var r2;
    return (r2 = t.closeButton) != null ? r2 : et;
  }, [t.closeButton, et]), Tt = React2.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = React2.useRef(0), U2 = React2.useRef(0), St = React2.useRef(0), K = React2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N2 === "loading";
...
function CurrencyProvider({ children }) {
  const [currency, setCurrencyState] = reactExports.useState(() => {
    try {
  ...
  const setCurrency = reactExports.useCallback((c) => {
    setCurrencyState(c);
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CurrencyContext.Provider, { value: { currency, setCurrency, format }, children });
}
function useCurrency() {
  return reactExports.useContext(CurrencyContext);
}
const OrdersPage = reactExports.lazy(() => __vitePreload(() => import("./OrdersPage-l5ga8AnI.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const QuotationsPage = reactExports.lazy(() => __vitePreload(() => import("./QuotationsPage-D5pNE7tQ.js"), true ? __vite__mapDeps([4,1,2]) : void 0));
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-CspVPk7f.js"), true ? __vite__mapDeps([5,2,3]) : void 0));
const TutorialPage = reactExports.lazy(() => __vitePreload(() => import("./TutorialPage-F0upVbeh.js"), true ? [] : void 0));
...
function AppShell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex flex-col items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-[480px] min-h-screen flex flex-col bg-background relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppHeader, { subtitle: TAB_SUBTITLES[activeTab] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 pb-16 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      reactExports.Suspense,
      {
        fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-48", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full border-2 border-accent border-t-transparent animate-spin" }) }),
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              activeTab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsx(OrdersPage, {}),
              activeTab === "quotations" && /* @__PURE__ */ jsxRuntimeExports.jsx(QuotationsPage, {}),
              activeTab === "reports" && /* @__PURE__ */ jsxRuntimeExports.jsx(ReportsPage, {}),
              activeTab === "tutorial" && /* @__PURE__ */ jsxRuntimeExports.jsx(TutorialPage, {})
            ]
          },
          activeTab
        )
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "light", enableSystem: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CurrencyProvider, { children: [
...
export {
  ...
  ReactDOM$2 as t,
  useCurrency as u,
  pendingThenable as v,
  resolveEnabled as w,
  resolveStaleTime as x,
  environmentManager as y,
  isValidTimeout as z
};
